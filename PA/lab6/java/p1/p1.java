...
class Nim {
    ...
    public int eval(int player) {
        ...
        // Nu exista o euristica pentru Nim, asa ca intoarcem 0.
        return 0;
    }
    ...
    public boolean apply_move(Move move) {
        ...
        if (move.amount < 1 || move.amount > 3)
            return false;
...
class P1 {
    ...
    public static Pair<Integer, Move> minimax(Nim init, int player, int depth) {
         ...
         */
        for (Move move: moves) {
            Nim state_clone = (Nim) init.clone();
